export class AppSettings {
    private static findAddress =()=>{
        ...
        if(process.env.NODE_ENV=="development") return "http://192.168.43.239:8888";
        else if(process.env.NODE_ENV=="production") return "http://192.168.43.239:8888"; //TO Modify with prod server
    };
